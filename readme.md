...
Branch protection rule для веток ниже `[dps][ert][voa]*`:
- dev
- prod
- stage

Абсолютно отвратительный паттерн, который берет 3 раза по каждой букве каждой ветки. Паттерн передается _fnmatch_ 
